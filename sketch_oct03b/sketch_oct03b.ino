...
#define TOPICO_SUBSCRIBE "INCB_ESP32_recebe_informacao_Luiz"
/* Tópico MQTT para envio de informações do ESP32 para broker MQTT */
#define TOPICO_PUBLISH   "teste"
...
const char* PASSWORD = "pimpa123";

/* URL do broker MQTT que deseja utilizar */
const char* BROKER_MQTT = "191.233.247.255";
...
void loop()
{
  ...
  if (digitalRead(buttonPin) == LOW) {
    ...
    sprintf(msg, "%ld", randNumber); 
    MQTT.publish(TOPICO_PUBLISH, msg);/*GERAR NUMERO ALEATORIO*/
    Serial.println("ENVIADO BOTAO");
  }
